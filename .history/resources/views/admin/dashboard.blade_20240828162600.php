        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3 mt-3">
                    <div class="card car-blue">
                        <div class="content">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="icon-big text-center">
                                        <i class="blue teal fas fa-shopping-cart"></i>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="detail">
                            ...
                            <div class="footer">
                                <hr />
                                <div class="stats">
                                    <i class="fas fa-calendar blue"></i> For this Week
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3 mt-3">
                    <div class="card car-white">
                        <div class="content">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="icon-big text-center">
                                        <i class=" white  fas fa-money-bill-alt"></i>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="detail">
                            ...
                            <div class="footer">
                                <hr />
                                <div class="stats">
                                    <i class="white fas fa-calendar"></i> For this Month
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card car-blue">
                        <div class="content">
                            ...
                            <div class="footer">
                                <hr />
                                <div class="stats">
                                    <i class="white fas fa-stopwatch"></i> For this Month
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card car-white">
                        <div class="content">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="icon-big text-center">
                                        <i class="blue fas fa-envelope"></i>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="detail">
                            ...
                            <div class="footer">
                                <hr />
                                <div class="stats">
                                    <i class="blue fas fa-envelope-open-text"></i> For this week
                                </div>
                            </div>
                        </div>
                    </div>
