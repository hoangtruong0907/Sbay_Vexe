                ...
                <div class="wrap-left-ant-row-flex" style="position: relative;">
                    ...
                    <div class="departure-plane-date flex-sum-left">
                        <i class="fa fa-calendar" aria-hidden="true"></i> <input type="date" name=""
                            value="<?php echo e($params->dateTo ?? ''); ?>" class="date-input" placeholder="">
                    </div>
            ...
            <div class="left-ant-row-flex">
                <div class="wrap-left-ant-row-flex" style="position: relative;">
                                    ...
                                    <div class="custom-input-container">
                                        ...
                                        <div class="custom-input-section">
                                            <input type="text" id="train_from" hidden
                                                value="<?php echo $params->trainFrom->station_code ?? ''; ?>" />
                                            <input type="text" id="train_from_input" placeholder="Ga Đi"
                                                ...
                                                value="<?php echo $params->trainFrom->station_name ?? ''; ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="departure-train-date flex-sum-left">
                        ...
                        <input type="text" id="train_date_to" value="<?php echo $params->dateTo ?? ''; ?>" class="date-input"
...
<<<<<<<< HEAD:storage/framework/views/68e15beb1df3920586f0e773e9e94dea.php
<?php /**PATH /Applications/sbayht copy 4/sbay_vexere/resources/views/components/search_component.blade.php ENDPATH**/ ?>
========
<?php /**PATH /Applications/sbayht copy 6/sbay_vexere/resources/views/components/search_component.blade.php ENDPATH**/ ?>
>>>>>>>> origin/feature/blog3:storage/framework/views/bd2d99c912162c7e71fb308364435c86.php
