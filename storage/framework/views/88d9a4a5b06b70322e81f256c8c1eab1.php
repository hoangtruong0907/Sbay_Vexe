...
<div class="container-table ffff">
    ...
    <form action="<?php echo e(route('admin.blogs.destroy', $post->id)); ?>" method="POST" style="display:inline;">
        <?php echo csrf_field(); ?>
        <?php echo method_field('DELETE'); ?>
        <button type="submit" class="btn-action delete">Delete</button>
    </form>

    <a href="<?php echo e(route('blog.content', ['slug' => \Illuminate\Support\Str::slug($post->title, '-')])); ?>" class="btn-action">Link</a>
</td>
            </tr>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/sbayy/sbay_vexere/resources/views/admin/blogs/index.blade.php ENDPATH**/ ?>