<nav id="sidebar" class="active">
    <div class="sidebar-header">
        <img src="<?php echo e(asset('images/bootstraper-logo.png')); ?>" alt="bootraper logo" class="app-logo">
    </div>
    <ul class="list-unstyled components text-secondary">
        ...
        <li>
        <a href="<?php echo e(route('admin.blogs.index')); ?>"><i class="fas fa-file-alt"></i> Blog</a>
...
<<<<<<<< HEAD:storage/framework/views/2787d82187d72a8e748dbda70493edd5.php
</nav><?php /**PATH /Applications/sbayht copy 4/sbay_vexere/resources/views/admin/components/sidebar.blade.php ENDPATH**/ ?>
========
</nav><?php /**PATH /Applications/sbayht copy 6/sbay_vexere/resources/views/admin/components/sidebar.blade.php ENDPATH**/ ?>
>>>>>>>> origin/feature/blog3:storage/framework/views/097aecde37d1f03ecc5071ab3ddafaff.php
