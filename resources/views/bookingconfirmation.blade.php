...
@section('content')
    <div style="background: rgb(242, 242, 242);">
        ...
        <div class="container mx-auto flex-column flex gap-3" style="padding: 20px 0px; width: 1016px;">
            ...
            <div class="d-flex gap-4">
                ...
                <div class="d-flex flex-column gap-3 w-100">
                    <div
                        class="d-flex border flex-column gap-3 border-light-subtle p-4 left-top bg-white rounded-2 card-border-radius card-border-radius">
                    ...
                    <!--bottom-left section -->
                    <div
                        class="d-flex flex-column gap-3 bg-white border border-light-subtle rounded-2 p-4 card-border-radius">
                        <div class="container">
                ...
                <!-- Right section -->
                <div class="d-flex flex-column gap-3 w-right-section" style="width: 375px; min-width: 375px;">
                    <!--Right top -->
                    <div
                                            ...
                                            <div class="mx-auto d-grid w-100">
                                                ...
                                                <div class="d-flex pointer" data-bs-toggle="offcanvas"
                                                    ...
                                                    <div class="d-flex gap-2 mx-auto justify-content-between w-100">
                                                        ...
                                                        <div class="d-flex justify-content-center text-nowrap">
                                                            <p class="fw-bold text-primary mb-0"
                                                                data-bs-toggle="offcanvas" data-bs-target="#changeRight"
        ...
        <div style="border-top: 1px solid rgb(224, 224, 224); background: white;">
            <div class="container d-flex py-4 mx-auto" style="max-width: 1016px; gap: 20px;">
                <div class="d-flex flex-column gap-3 w-100">
                    <div class="d-flex gap-3 w-100 text-center">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="countryPhonesRight"
            aria-labelledby="countryPhonesRightLabel" style="width: 560px;">
        ...
        <!-- Chi tiết chuyến đi-->
        <div class="offcanvas offcanvas-end" tabindex="-1" id="tripDetailsRight"
            aria-labelledby="tripDetailsRightLabel" style="width: 560px;">
            <div class="d-flex flex-row align-items-center bg-primary" style="min-height: 72px; padding: 16px;">
                <div class="pointer text-white" style="width: 24px; height: 24px;" data-bs-dismiss="offcanvas"
                    aria-label="Close">
                    <i class="material-icons-round ">arrow_back</i>
                        ...
                        <div class="d-grid gap-2">
                            <div class="d-flex justify-content-between gap-5">
                                <p class="fw-normal text-nowrap mb-0" style="line-height: 20px; letter-spacing: 0px;">
                                    Tuyến</p>
                                <span class="fw-medium text-end mb-0 "
                                            ...
                                            <tr id="1">
                                                ...
                                                <td id="vxr-1-3">
                                                    <div class="Seat__SeatContainer-sc-5i6bij-0 hWCxok">
                                                        <div color="#ae70ff"
                                                            class="Seat__SeatImageContainer-sc-5i6bij-1 qIAFz"><span
                                                                class="seat-color-selected"><svg width="40"
                            ...
                            <div class="d-flex flex-column gap-2" data-bs-toggle="offcanvas"
                                data-bs-target="#changeRight" aria-controls="changeRight">
                                <div class="d-flex justify-content-between">
                ...
                <div class="d-flex flex-column" style="min-width: 232px;">
                    <label class="d-flex align-items-start mb-0"
                        ...
                        <input class="form-check-input" type="radio" name="flexRadioDefault"
                            id="flexRadioDefault1" value="Sân Bay Nội Bài ( Sảnh E Ga Nội Địa T1)-122778-175340-0"
                            checked />
                    ...
                    <!--end row -->
                    <label class="d-flex align-items-start mb-0"
                        style="padding: 16px 0 0 20px; background-color: unset;">
                        <input class="form-check-input" type="radio" name="flexRadioDefault"
                            id="flexRadioDefault1" value="Sân Bay Nội Bài ( Sảnh E Ga Nội Địa T1)-122778-175340-0" />
                        <div style="flex: 1 1 0%; padding: 0px; margin-left: 12px;">
                            <div class="d-flex flex-column "
        ...
        <!-- Sắp xếp theo -->
        <div class="offcanvas offcanvas-bottom" tabindex="-1" id="sortedByShow"
            ...
            <div class="offcanvas-body">
                <div class="p-0" style="min-width: 232px;">
                    <div class="btn-group-vertical w-100" role="group"
                        ...
                        <input type="radio" class="btn-check" name="radio-options" id="radio1"
                            value="time#asc" checked data-bs-dismiss="offcanvas" aria-label="Close">
                        <label class="btn btn-outline-dark" for="radio1">Sớm nhất</label>

                        <input type="radio" class="btn-check" name="radio-options" id="radio2"
                            value="time#desc" data-bs-dismiss="offcanvas" aria-label="Close">
                        <label class="btn btn-outline-dark" for="radio2">Muộn nhất</label>

                        <input type="radio" class="btn-check" name="radio-options" id="radio3"
                            value="distance#asc" data-bs-dismiss="offcanvas" aria-label="Close">
        ...
        <div class="offcanvas offcanvas-bottom" tabindex="-1" id="changeLocationShow"
            aria-labelledby="offcanvasBottomLabel"
        ...
        <!-- Báo cáo với chúng tôi -->
        <div class="offcanvas offcanvas-bottom" tabindex="-1" id="reportUsShow"
            aria-labelledby="offcanvasBottomLabel"
            style="border-radius: 16px 16px 0 0;height: 560px; width: 560px; right: 0; left: auto;">
            <div class="offcanvas-header d-flex w-100 justify-content-center">
                        ...
                        <ul class="nav nav-fill nav-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active text-secondary pointer text-nowrap" id="fill-tab-0"
                                    ...
                                    aria-controls="fill-tabpanel-0" aria-selected="true">
                                    Quyền lợi
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-secondary pointer text-nowrap" id="fill-tab-1"
                                    data-bs-toggle="tab" href="#fill-tabpanel-1" role="tab"
                                    aria-controls="fill-tabpanel-1" aria-selected="false">
                                    Điệu kiện bảo hiểm
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-secondary pointer text-nowrap" id="fill-tab-2"
                                    data-bs-toggle="tab" href="#fill-tabpanel-2" role="tab"
                                ...
                                <div class="d-flex flex-column pb-0 ps-2 pe-2">
                                    ...
                                    <div class="alert alert-warning d-flex align-items-center p-2 ms-1"
                                        ...
                                        <img class="p-2"
                                            ...
                                            alt="warning">
                                        <p>
                                            Chính sách hoàn hủy chuyến đi có hiệu lực trong vòng <span
                                                class="fw-bolder">48
