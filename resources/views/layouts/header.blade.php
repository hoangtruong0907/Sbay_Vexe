...
<header>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href=""><i class="fa fa-sign-in icon-header" aria-hidden="true"></i> <span class="text-container k1">Đăng
                nhập/Đăng ký</span></a>
        <a href=""><i class="fa fa-car icon-header" aria-hidden="true"></i> <span class="text-container k2">Thuê
                xe</span></a>
        <a href=""><i class="fa fa-plane icon-header" aria-hidden="true"></i> <span class="text-container k3">Vé máy
                bay</span></a>
        <a href=""><i class="fa fa-download icon-header" aria-hidden="true"></i> <span class="text-container k4">Tải app
                Vexere</span></a>
        ...
        <a href=""><i class="fas fa-handshake icon-header" aria-hidden="true"></i> <span class="text-container k5">Mở
                bán tại Vexere</span></a>
        <a href=""><i class="fas fa-bus icon-header" aria-hidden="true"></i> <span class="text-container k6">Phần mềm
                nhà xe</span></a>
        <a href=""><i class="fas fa-store icon-header" aria-hidden="true"></i> <span class="text-container k7">Phần mềm
                đại lý</span></a>
        <a href=""><i class="label"></i> <span class="text-container"><b>Về Vexere</b></span></a>
        <a href=""><i class="fas fa-star icon-header" aria-hidden="true"></i> <span class="text-container k8">Giới
                thiệu</span></a>
        <a href=""><i class="fas fa-wifi icon-header" aria-hidden="true"></i> <span class="text-container k9">Vexere
                Blog</span></a>
        <a href=""><i class="fas fa-briefcase icon-header" aria-hidden="true"></i> <span
                class="text-container k10">Tuyển dụng</span></a>
        <a href=""><i class="label"></i><span class="text-container"><b>Hỗ trợ</b></span></a>
        <a href=""><i class="fa fa-phone icon-header" aria-hidden="true"></i> <span class="text-container k11">Liên
                hệ</span></a>
        <a href=""><i class="fas fa-question icon-header" aria-hidden="true"></i> <span class="text-container k12">Câu
                hỏi thường gặp</span></a>
        <a href=""><i class="fas fa-gavel icon-header" aria-hidden="true"></i> <span class="text-container k13">Quy
                chế</span></a>
        <a href=""><i class="fas fa-lock icon-header" aria-hidden="true"></i> <span class="text-container k14">Chính
                sách bảo mật thông tin</span></a>
        <a href=""><i class="fas fa-credit-card icon-header" aria-hidden="true"></i> <span
                class="text-container k15">Chính sách bảo mật thanh toán</span></a>
        <a href=""><i class="fas fa-credit-card icon-header" aria-hidden="true"></i> <span
                class="text-container k16">Chính sách và quy trình giải quyết tranh chấp, khiếu nại</span></a>
    </div>
    </div>
    ...
    <div class="total-header">
        ...
        <ul class="right-header nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link nav-link-header dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                ...
                <ul class="dropdown-menu dropdown-menu-end"
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('auth.info') }}">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/Auth/account-circle.svg" width="16"
                                height="16" alt="">
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('auth.membership') }}">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/loyalty.svg" width="16" height="16"
                                alt="">
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('auth.ticket') }}">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/ticket.svg" width="16" height="16"
                                alt="">
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('auth.review') }}">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/review.svg" width="16" height="16"
                                alt="">
            ...
            <div class="modal-body">
                <div class="mb-4">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" name="phone" class="form-control flex-grow-1" style="flex-grow: 1;"
                            id="add_phoneNumber" placeholder="Số điện thoại">
                    </div>
                </div>
