            ...
            <div class=" d-flex flex-column gap-3 w-100">
                <div class="left-section d-flex border flex-column border-light-subtle p-4 left-top bg-white rounded-2 card-border-radius card-border-radius">
                    ...
                    <form action="{{route('booking.store')}}" method="POST" accept-charset="UTF-8" id="bookingForm">
                        ...
                        <div class="form-floating-label my-4">
                        ...
                        <div class="d-flex flex-row my-4">
                            <div class="me-1 align-items-center border rounded-3 bg-white text-dark pointer" style="padding: 12px 10px; height: calc(3.1rem + 1px);" data-bs-toggle="offcanvas" data-bs-target="#countryPhonesRight" aria-controls="countryPhonesRight">
                                <p class="mb-0" style="line-height: 1.5;">🇻🇳 +84</p>
                            </div>
                            <div class="form-floating-label flex-grow-1 mb-0">
                                <input type="text" id="phone" name="customer_phone" placeholder=" "  value="{{ Auth::user()->phone ?? '' }}">
                                <label for="phone">Số điện thoại <span class="text-danger">*</span></label>
                                <div class="error-message text-danger"></div> <!-- Thông báo lỗi sẽ hiển thị ở đây -->
                            </div>
                        </div>
                    
                        <div class="form-floating-label mt-4 mb-2">
