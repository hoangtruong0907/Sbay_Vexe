...
<div class="row">
                ...
                <div class="qr-details" id="qr-details" style="display: none;">
                    ...
                    <div class="bank-support">
                        ...
                        <div class="support-info expandable" id="support-info">
                            ...
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Wallet-0.png" alt="MoMo">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Wallet-7.png" alt="viettel">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Wallet-6.png" alt="cake">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Bank-1.png" alt="ACB">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Bank-2.png" alt="Bank 1">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Bank-4.png" alt="Bank 2">
                            <img src="https://229a2c9fe669f7b.cmccloud.com.vn/images/bank_wallet/Bank-38.png" alt="Bank 3">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center" onclick="toggleTotalDetails()">
                ...
                <div class="d-flex align-items-center">
                    <h4 class="mb-0 me-2">850.000đ</h4>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="tripDetailsRight" aria-labelledby="tripDetailsRightLabel">
        ...
        <div class="offcanvas-body p-3">
            ...
            <div class="route">
                <p class="mb-1 fw-bold">Mã ghế/ giường</p>
                <span class="text-secondary">A2</span>
            </div>
            <div class="route">
                <p class="mb-1 fw-bold">Tạm tính</p>
                <span class="text-secondary">140.000₫</span>
            </div>
            ...
            <p class="text-secondary">16 Đường 3/2, Thuận Phước, Hải Châu, Đà Nẵng, Phường Thuận Phước, Hải Châu, Đà
                Nẵng</p>
            <p class="text-secondary">Dự kiến đón lúc: 15:00 11/09/2024</p>
            <div class="group-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
            ...
            <p class="text-secondary">Dự kiến trả lúc: 17:00 11/09/2024</p>
        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="changeLocationRight"
                ...
                <div class="location-info">
                    <div class="location-details">
                        <div class="location-info-text">
                            ...
                            <p class="route-location">VP Đà Nẵng</p>
                            <p class="location-description">16 Đường 3/2, Thuận Phước, Hải Châu, Đà Nẵng, Phường Thuận
                                Phước, Hải Châu, Đà Nẵng</p>
                            <p class="location-price text-danger">220.000đ / nhóm từ 1-3 khách (trả tại website Vexere)
                            </p>
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mt-4 mb-4 mb-0">Thông tin liên hệ</h4>
...
<div class="fixed-payment-button">
    <div class="d-flex justify-content-between align-items-center flex-wrap payment-info-container">
        ...
        <p class="text-center mt-2 mb-0 w-100 order-1 order-md-0">Bằng việc nhấn nút Thanh toán, bạn đồng ý với <a
                href="#" class="text-primary">Chính sách bảo mật thanh toán</a></p>
        <p class="small-2 mt-2 mb-0 payment-note order-0 order-md-1">Bạn sẽ sớm nhận được biển số xe, số điện thoại tài
            xế
...
// Toggle bank support information
...
// Thêm bảo hiểm
document.getElementById('add-insurance').addEventListener('click', function(e) {
    e.preventDefault();
    document.getElementById('insurance-info').style.display = 'none';
    document.getElementById('insurance-details').style.display = 'flex';
});

// Hủy bảo hiểm
document.getElementById('remove-insurance').addEventListener('click', function(e) {
    e.preventDefault();
...
// Show Convenience Store Payment Details
