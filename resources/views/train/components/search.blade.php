...
<div class="search-widget-inner-content custom-tab_pane">
    <div class="d-flex flex-row flex-wrap">
        <div class="left-ant-row-flex">
            <div class="wrap-left-ant-row-flex position-relative row">
                {{-- Nơi xuất phát --}}
                <div class="flex-sum-left col-lg-3 col-md-6 col-sm-12">
                            ...
                            <div class="custom-select-container custom-train-from-select">
                                ...
                                <ul class="custom-dropdown-menu train-dropdown-menu w-100 w-md-75">
                                    <li class="custom-dropdown-item-group custom-dropdown-item-group-xe-tau">
                                        <p class="fw-bold p-0 p-md-2 ps-4 mt-2">
                                            Thành phố, nhà ga phổ
                                            biến</p>
                                        <ul class="list-unstyled m-0 p-0 overflow-scroll" style="max-height: 300px;"
                                            id="dropdown_list_train_from">
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="position-absolute top-10 end-0 bg-light d-none d-md-block"
                ...
                <div class="flex-sum-left col-lg-3 col-md-6 col-sm-12">
                    <div class="custom-input-col custom-train-to-input-col w-100">
                        <div class="custom-select-wrapper custom-train-to-select-wrapper">
                            <div class="custom-select-container custom-train-to-select">
                                ...
                                <ul class="custom-dropdown-menu train-dropdown-menu w-100 w-md-75">
                                    <li class="custom-dropdown-item-group custom-dropdown-item-group-xe-tau">
                                        <p class="fw-bold p-0 p-md-2 ps-4 mt-2">Thành phố, nhà ga phổ
                                            biến</p>

                                        <ul class="list-unstyled m-0 p-0 overflow-scroll" style="max-height: 300px;"
                                            id="dropdown_list_train_to">
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="position-absolute top-10 end-0 bg-light d-none d-md-none d-lg-block"
                        style="width: 2px;height: 100%;">
                    </div>
                </div>
                {{-- Ngày đi --}}
                <div class="flex-sum-left position-relative col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="d-flex flex-row ps-3 h-100">
                        ...
                        <div class="d-flex flex-column justify-content-center custome-departure-date-select">
                            <div class="d-flex flex-row justify-content-between">
                                <div class="w-100">
                                    <p class="base__Caption-sc-1tvbuqk-26 hTYbup text-secondary">Ngày đi
                                    </p>
                        ...
                        <ul class="dropdown-menu p-3 shadow w-100" aria-labelledby="dropdownPassenger"
                            ...
                            <li class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="number" id="numberValueAdult"
                                        class="mx-3 fw-bold text-center custom-input_number" value="1"
                                        min="1" style="width: 25px; border: 0" readonly>
                            ...
                            <li class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                <div class="pe-3 d-flex flex-column">
                                    ...
                                    <small class="text-muted text-secondary">Từ 0 - 10 tuổi vào ngày khởi hành, ưu đãi
                                        áp
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="number" id="numberValueChildren"
                                        class="mx-3 fw-bold text-center custom-input_number" value="0"
                                        min="0" style="width: 20px; border: 0" readonly>
                                    <button class="btn btn-circle btn-light-blue increment-btn"
                                        data-target="#numberValueChildren">
                                        <i class="bi bi-plus text-primary"></i>
                                    </button>
                            ...
                            <li class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="number" id="numberValueSeniors"
                                        class="mx-3 fw-bold text-center custom-input_number" value="0"
                                        min="0" style="width: 25px; border: 0" readonly>
                                    <button class="btn btn-circle btn-light-blue increment-btn"
                                        data-target="#numberValueSeniors">
                                        <i class="bi bi-plus text-primary"></i>
                                    </button>
                            ...
                            <li class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="number" id="numberValueStudent"
                                        class="mx-3 fw-bold text-center custom-input_number" value="0"
                                        min="0" style="width: 25px; border: 0" readonly>
                                    <button class="btn btn-circle btn-light-blue increment-btn"
                                        data-target="#numberValueStudent">
                            ...
                            <li class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="number" id="numberValueUnion_member"
                                        class="mx-3 fw-bold text-center custom-input_number" value="0"
                                        min="0" style="width: 25px; border: 0" readonly>
                                    <button class="btn btn-circle btn-light-blue increment-btn"
                                        data-target="#numberValueUnion_member">
        ...
        {{-- nút Tìm kiếm --}}
        <div class="custom-btn_search_style">
            <button class="custom-btn_search" id="train_search">Tìm kiếm</button>
        </div>
    </div>
</div>
