...
@section('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/train-item-seat.css') }}">
    <link rel="stylesheet" href="{{ asset('css/train-item-seat-mobile.css') }}">
    <link rel="stylesheet" href="{{ asset('css/train_style.css') }}">
    <link rel="stylesheet" href="{{ asset('css/train-item-detail-mobile.css') }}">
