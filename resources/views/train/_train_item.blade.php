                                    ...
                                    <div class="action-train">
                                        <div class="action-l">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="collapse"
                                                data-bs-target="#ticket-detail-collapse-{{ $key }}" aria-expanded="false"
        ...
        $minutes = $route['duration'] % 60;       // Tính số phút
            ...
            <div class="notify-trip-l">
                <div class="full-trip-l pt-2">
                    ...
                    <p>Vé chặng thuộc chuyến {{ $route['time'] }} - {{ $route['arrival_time'] }} ngày {{ $route['date'] }}
                    ...
                    <div class="bigger-main">
                        <div class="tail-contai">
                            <img class="contain-description lazyloaded"
                                ...
                                src="https://storage.googleapis.com/fe-production/images/image_dsvn.png" alt="default-alt"
                                width="32" height="18">
