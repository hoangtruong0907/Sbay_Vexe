    ...
    <div class="container-l">
        ...
        <div class="collapse ticket-step-collapse" id="ticket-step-collapse-{{ $key }}"
            ...
            <div class="steps-container-train">
                <div id="step-1-{{ $key }}"
                    class="step-train step-active navigation-step navigation-step-active">
                    <div class="step-icon-train step-icon-n step-content2">1</div>
                    Chỗ mong muốn
                </div>
                <div id="step-2-{{ $key }}"
                    class="step-train step-inactive navigation-step navigation-step-inactive">
                    ...
                    <div id="step1-{{ $key }}" class="wizard-step-train active-train">
                        ...
                        <div class="coupon-container-train">
                            ...
                            <div class="wrap-coupon-train">
                                ...
                                <button id="button-step-custom-1-{{ $key }}"
                                    class="navigation-button-custom" data-key="{{ $key }}" data-step="1">
                            ...
                            <div class="wrap-coupon-train">
                                <input class="Coupon__HiddenInput-sc-1mhp588-4 cFDugh" value="FS060824VXR10">
                                <button id="button-step-custom-2-{{ $key }}"
                                    class="navigation-button-custom" data-key="{{ $key }}" data-step="2">
                                    <div class="kNCupL-train">
                                        <div class="border-coupon-train">
                                            <div class="flex-coupon-train ">
                                                <div class="count text-center">
                            ...
                            <div class="wrap-coupon-train">
                                <input class="Coupon__HiddenInput-sc-1mhp588-4 cFDugh" value="FS060824VXR10">
                                <button id="button-step-custom-3-{{ $key }}"
                                    class="navigation-button-custom" data-key="{{ $key }}" data-step="3">
                                    ...
                                    <div class="seat-info-train">
                                        <div class="seat-thumbnail seat-unavailable-train">
                                            <svg width="60" height="52" viewBox="0 0 60 52" fill="none"
                                                ...
                                                <rect x="0" y="12" width="6" height="20" rx="4"
                                                    fill="#333" stroke="#888" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                                <rect x="6" y="8" width="48" height="16" rx="3"
                                                    fill="#333" stroke="#888" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                                <rect x="6" y="24" width="48" height="16" rx="3"
                                                    fill="#333" stroke="#888" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                                <rect x="54" y="12" width="6" height="20" rx="4"
                                                    fill="#333" stroke="#888" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                    ...
                                    <div class="seat-info-train">
                                        <div class="seat-thumbnail seat-discount-train" color="#fba442">
                                            <svg width="60" height="52" viewBox="0 0 60 52" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" style="width: 60px; height: 52px;">
                                                <rect x="0" y="12" width="6" height="20" rx="4"
                                                    fill="#FFF" stroke="#FFA500" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                                <rect x="6" y="8" width="48" height="16" rx="3"
                                                    fill="#FFF" stroke="#FFA500" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                    ...
                                    <div class="seat-info-train">
                                        <div class="seat-thumbnail seat-group-train" color="#ae70ff">
                                            <svg width="60" height="52" viewBox="0 0 60 52" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" style="width: 60px; height: 52px;">
                                                <rect x="0" y="12" width="6" height="20" rx="4"
                                                    fill="#FFF" stroke="#9C27B0" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                                <rect x="6" y="8" width="48" height="16" rx="3"
                                                    fill="#FFF" stroke="#9C27B0" stroke-width="1.5"
                                                    stroke-linejoin="round"></rect>
                                                        ...
                                                        <td class="seat">
                                                            <div class="modal-choose-chair-train"
                                                                ...
                                                                <svg width="48" height="32"
                                                                    ...
                                                                    <rect x="0" y="8" width="6" height="16"
                                                                        rx="4" fill="#FFF"
                                                                        stroke="#B8B8B8" stroke-width="1.5"
                                                                        stroke-linejoin="round">
                                                                    </rect>
                                                                    <rect x="6" y="4" width="36" height="12"
                                                                        rx="3" fill="#FFF"
                                                                        stroke="#B8B8B8" stroke-width="1.5"
                                                                        stroke-linejoin="round">
                                                                    </rect>
                                                                    <rect x="6" y="16" width="36" height="12"
                                                                        rx="3" fill="#FFF"
                                                                        stroke="#B8B8B8" stroke-width="1.5"
                                                                        stroke-linejoin="round">
                                                                    </rect>
                                                                    <rect x="42" y="8" width="6" height="16"
                                                                        rx="4" fill="#FFF"
                                                                        stroke="#B8B8B8" stroke-width="1.5"
                                                                        stroke-linejoin="round">
                                                                    </rect>
                                        ...
                                        <div class="shipSeat gap-3 mb-3">
                                            ...
                                            <div class="bg-secondary-subtle p-4 align-self-center rounded">
                                                <div class=" d-flex gap-5 align-items-center">
                                                    <svg width="70" height="50" viewBox="0 0 28 40"
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-column px-2 flex-grow-1">
                                        ...
                                        <div class="w-container-train">
                                            <span
                                                class="w-content-train bg-primary text-wrap my-2 px- py-1">+46</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="qrcode-content">
                                ...
                                <div class="qrcode-item my-3 ">
                                    ...
                                    <div
                                        class="row row-train d-flex align-items-center text-center border-bottom border-top pt-2 pb-1">
                                        <div class="col col-train d-flex justify-content-center item-abate">
                                            <img src="https://cardtot.com/wp-content/uploads/2020/01/zalopay.png"
                                                alt="" class="img-fluid-train">
                                        </div>
                                        <div class="item-col-train col-8 text-start">
                                            <b>Ví ZaloPay</b>
            ...
            <div class="total-amount-train">
                ...
                <div class="right-total-amount-train ">
                    <div class="text-total-amout"> <span> Tổng cộng: </span><span
                            class="right-total-train">0đ</span>
                    </div>
                    <div>
