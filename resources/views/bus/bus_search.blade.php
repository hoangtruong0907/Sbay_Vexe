                                    ...
                                    <div class="input-group">
                                        <div class="input-item">
                                            <p class="input-label">Từ</p> 
                                             <input type="text" value="00:00" class="input-time from-time" id="fromTime"> 
                                        </div>
                                        <div class="divider"></div>
                                        <div class="input-item">
                                            <p class="input-label">Đến</p>
                                            <input type="text" value="24:00" class="input-time to-time" id="toTime">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <li class="tree-treenode-switcher list-search_filter"> 
                                                <div class="d-flex align-items-center"> 
                                                    ...
                                                    <span class="tree-checkbox">
                                                        <input type="checkbox" class="form-check-input tree-checkbox-inner select_pp_district" value="{{ $districtName }}">
                                                    </span>  
                                                ...
                                                <ul class="tree-child-tree d-none">
                                                    @foreach ($info['names']->unique() as $name => $count)
                                                        <li class="tree-treenode-switcher d-flex">  
                                                            <span class="tree-checkbox">
                                                                <input type="checkbox" class="form-check-input tree-checkbox-inner select_pp_district_name" value="{{ $name }}">
                                                            </span>  
                                        ...
                                        @foreach ($list_dp_districts as $districtName => $info)
                                            <li class="tree-treenode-switcher list-search_filter"> 
                                                <div class="d-flex align-items-center"> 
                                                    ...
                                                    <span class="tree-checkbox">
                                                        <input type="checkbox" class="form-check-input tree-checkbox-inner select_dp_district" value="{{ $districtName }}">
                                                    </span>  
                                                    <span class="tree-content district-name" for="pp_district">
                                                        {{ $districtName }} ({{ $info['count'] }})
                                                    </span> 
                                               ...
                                               <!-- tên địa điểm -->
                                                <ul class="tree-child-tree d-none">
                                                    @foreach ($info['names']->unique() as $name => $count)
                                                        <li class="tree-treenode-switcher d-flex">  
                                                            <span class="tree-checkbox">
                                                                <input type="checkbox" class="form-check-input tree-checkbox-inner select_dp_district_name" value="{{ $name }}">
                                                            </span>  
                                                            <span class="tree-content district-name">
                                                                {{ $name }} ({{ $count }})
                                                            </span>
                            ...
                            <div class="filter-content">
                                <div class="filter-item-n">
                                    <div class="filter-item-content-n">
                                        ...
                                        <div class="quantity-input-n">
                                            <button disabled="" type="button"
                                                class="ant-btn-n QuantityInput__RoundButton-sc-5ap7dx-1 bVEmRj" id="seat_decrease">
                                                <i class="fa fa-minus-square" aria-hidden="true"></i>
                                            </button>
                                            <div class="quantity-value-n">
                                            ...
                                            <button type="button"
                                                class="ant-btn-n QuantityInput__RoundButton-sc-5ap7dx-1 bVEmRj" id="seat_increase">
                                                <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="filter-content">
                                <div class="groupItems">
                                    <div class="Rates__GroupRate-sc-1ioptsc-1 dfQbde" style="cursor: pointer;">
                                        ...
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span style="color: rgb(20, 20, 20);">trở lên (<span id="rating-count">1</span>)</span>
                                    </div>                                     
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input id="addressInput" type="text" class="form-control" placeholder="Nhập địa chỉ" oninput="searchAddress()" />
...
<div class="modal fade" id="dropoffModal" tabindex="-1" aria-labelledby="dropoffModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" id="dropoffInput" class="form-control" placeholder="Nhập địa chỉ" oninput="searchDropoffAddress()" />
