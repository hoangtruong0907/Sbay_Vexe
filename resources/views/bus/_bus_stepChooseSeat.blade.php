<div class="card card-body card-body-new">
                            ...
                            <div class="value-container">
                                ...
                                <button class="custom-address-button">
                                    ...
                                    <span id="changeLink" class="change-link text-pick-up-point-maps"
                                        onclick="openAddressModal()" style="display: none;">Thay đổi</span>
                                </button>
                            </div>
                        </div>
                            ...
                            @foreach ($pickupPoints as $index => $point)
                                <div class="form-check item point_id-1" data-id="{{ $point['id'] }}"
                                    ...
                                    <input class="form-check-input" type="radio"
                                        name="rdioCheckDrop-{{ $keyId }}" value="{{ $point['point_id'] }}"
                                        data-name="{{ $point['name'] }}" id="rdioCheckDrop-{{ $keyId }}"
                                        {{ $index == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="mapModalLabel{{ $index }}">
                            ...
                            <div class="value-container">
                                ...
                                <button class="custom-dropoff-button" style=" justify-content: flex-end;">
                                    <span id="displayDropoffAddress" class="address-container">
                                        <p class="text-drop-off-point-arrange text-drop-off-point-maps text-decoration-underline text-primary"
                                            style="margin-left: 31px;">
                                            Nhập địa chỉ tại đây
                                        </p>
                                    </span>
                                    <span id="changeDropoffLink" class="change-link text-drop-off-point-maps"
                                        onclick="openDropoffAddressModal()" style="display: none;">Thay đổi</span>
                                </button>
                            </div>
                        </div>
                            ...
                            @foreach ($dropOffPoints as $index => $point)
                                <div class="form-check item point_id-1" data-id="{{ $point['id'] }}"
                                    ...
                                    <input class="form-check-input" type="radio"
                                        ...
                                        value="{{ $point['point_id'] }}" id="rdioCheckTransfer-{{ $keyId }}"
                                    ...
                                    <div class="modal fade" id="mapModalDrop{{ $index }}" tabindex="-1"
                                        aria-labelledby="mapModalLabelDrop{{ $index }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
    ...
    <div class="total-amount">
        <div class="left-total-amount d-flex align-items-center">
            <button type="button" class="ant-btn-close me-1"><span><i class="fa-solid fa-arrow-up-from-bracket"></i>
                    Huỷ bỏ</span></button>
